...
def execute():
	...
	sle_gle_reposting_start_date = frappe.get_value("Reposting Settings", "Reposting Settings", "sle_gle_reposting_start_date")
	if not sle_gle_reposting_start_date:
		frappe.throw(_("SLE GLE Reposting Start Date not set in {0}").format(frappe.utils.get_url_to_form("Reposting Settings", "Reposting Settings")))
